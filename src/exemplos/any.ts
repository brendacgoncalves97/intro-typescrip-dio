// O any é uma notação que diz que a proriedade pode ter qualquer tipo
let cpf: any;
...
// E agora um número
cpf = 10;
// O uso de any fez com que typescript trate suas variáveis como JS
...
// E aqui passamos a variável cpf que contém um number, mas como ela é any, o TS não recclama porque ela pode conter qualquer atributo, inclusive uma string
apresentarCPF(cpf);
/**
