...
if (typeof valor === 'string') {
    nome = valor; // Isso funciona. Este tipo só pode ser atribuido se uma validação for feita
}
...
valorAny = true;
valorAny = 10;
nome = valorAny; // O perigo é que o any pode ser atribuído a qualquer variável tipada sem que seu tipo seja verificadp
